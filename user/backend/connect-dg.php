...
$insert="INSERT INTO confirmed(token,file_type,issued_to,role,purpose_of_mission,supervising_authority,
...
if($query){
    ...
    echo "<meta http-equiv='refresh' content='2; url=../djindex.php'>";
}
else{
