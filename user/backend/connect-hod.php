...
$insert="INSERT INTO approve_2(token,file_type,issued_to,role,purpose_of_mission,supervising_authority,
...
if($query){
    ...
    echo "<meta http-equiv='refresh' content='2; url=../hod-index.php'>";
}
else{
