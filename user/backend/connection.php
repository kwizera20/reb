...
$authorizedBy="Dr.Nelson MBARUSHIMANA";
$signature=$_POST['visa_destination'];
$arrivalDate=$_POST['arrival_date'];
$departureDate=$_POST['departure_date'];


$insert="INSERT INTO mission_order(user_id,token,file_type,issued_to,role,purpose_of_mission,supervising_authority,
district_of_origin,destination,distance,departure_date,returning_date,duration,vehicle_identification,
mission_allowance,issue_date,authorized_by,signature,arrival_date,departured_date,status) VALUES('$userid','$token','Mission order','$issued','$function',
...
if($query){
    echo "<script>alert('Mission Order Successfully submitted. ')</script>";
