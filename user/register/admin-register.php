<?php
    ...
    if(isset($_POST["register"])){
        ...
        if($move){
            $insert="INSERT INTO users(title,firstname,lastname,gender,phone,email,role,department,unit,pwd,picture)values( '$title','$firstname','$lastname','$gender','$phone','$email','$role','$department','$unit','$hashed','$imgNewName');";
		...
		<div class="form-v10-content">
			<form class="form-detail" action="#" method="POST" id="myform" enctype="multipart/form-data">
				<div class="form-left">
					...
					<div class="form-row">                    
						<select name="department" id="select" onchange="unitDispaly()" >                        
                    ...
                    <div class="form-row">
						<select name="unit" id="unit" onchange="roleDisplay()" >
					...
					<div class="form-row">
						<select name="role" class="role" id="role" >
                            ...
                            <option value="ud" >Unit Director</option>
